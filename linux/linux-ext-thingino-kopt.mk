...
define THINGINO_KOPT_PREPARE_KERNEL
	$(foreach mapping,$(THINGINO_DTS_MAPPINGS),\
		$(if $(BR2_LINUX_KERNEL_EXT_THINGINO_KOPT_DTS_$(word 1,$(subst |, ,$(mapping)))),\
			...
			$(INSTALL) -D -m 0644 \
				$(BR2_EXTERNAL_THINGINO_PATH)/board/ingenic/dts/t41nq.dtsi \
				$(LINUX_DIR)/arch/mips/boot/dts/ingenic/t41nq.dtsi ; \
			$(INSTALL) -D -m 0644 \
				$(BR2_EXTERNAL_THINGINO_PATH)/board/ingenic/dts/t41nq-pinctrl.dtsi \
				$(LINUX_DIR)/arch/mips/boot/dts/ingenic/t41nq-pinctrl.dtsi ; \
		)\
	)
endef
